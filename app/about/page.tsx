...
export default function AboutPage() {
  return (
    <div className="grid h-full grid-rows-6 gap-4 px-4 py-4 sm:px-6 sm:pb-8 sm:pt-4 2xl:px-8 2xl:pb-10 2xl:pt-6">
      <Header />
      <main className="row-span-5 row-start-2 grid h-full grid-cols-4 grid-rows-5 gap-4 sm:grid-cols-6 lg:grid-cols-8 xl:grid-cols-12">
        <p
          className={clsx(
        ...
        >
          ...
          sense of wonder for all of nature&apos;s expressions. Photography by{" "}
        ...
        <div className="col-start-1 row-start-2 aspect-[3/4] h-24 lg:row-start-1 2xl:h-28 -sm:hidden">
          <Image
        ...
        <div className="col-start-6 row-start-3 aspect-[3/4] h-24 lg:col-start-8 xl:col-start-12 2xl:h-28 -sm:hidden">
          <Image
            className="h-full w-full"
            src="/IMG_1663.png"
            alt="Photo of clouds"
        ...
        <div className="col-start-3 row-start-5 aspect-[3/4] h-24 lg:col-start-5 xl:col-start-6 2xl:h-28 -sm:hidden">
          <Image
            className="h-full w-full"
            src="/IMG_1663.png"
            alt="Photo of clouds"
